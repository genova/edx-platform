...
class PayAndVerifyTest(UniqueCourseTest):
    ...
    def test_immediate_verification_enrollment(self):
        ...
        enrolled_as_verified = self.dashboard_page.check_enrollment_mode(self.course_info["display_name"])
        self.assertTrue(enrolled_as_verified)
    ...
    def test_enrollment_upgrade(self):
        ...
        enrolled_as_honor = self.dashboard_page.check_enrollment_mode(self.course_info["display_name"], 'honor')
        self.assertTrue(enrolled_as_honor)
